...
class MSMainProcessor
{
    ...
    func queueRequest(requestConfiguration: MSRequestConfiguration,
        parameters: Dictionary<String, AnyObject>, callback: ProcessorCallback, methodRequestId: Int, requestId: String)
    {
            let req = requestConfiguration.getRequest(parameters,
    ...
    {
        return { (error: NSError, response: MSResponseMessage) in
    ...
    private func getResponseCallback(requestConfiguration: MSRequestConfiguration, callback: ProcessorCallback, methodRequestId: Int) -> SuccessRequestCallback {
            ...
            return { (response: AnyObject, requestOperation: MSResponseMessage) in
