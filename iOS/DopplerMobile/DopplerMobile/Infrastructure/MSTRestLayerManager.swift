//
//  MSTRestMethodsConfiguration.swift
//  MSRestKitProj
//
...
//    static let BaseURL = "https://restapi.fromdoppler.com"
    ...
    init()
    {
        ...
        MSRestClientManager.initializeWithConfiguration(MSRestConfiguration( requestConfigurationList: requestConfigurationList, baseURL: MSTRestLayerManager.BaseURL))
